...
// DOM ELEMENTS
var reservationBtn = document.querySelector('#btn-reservation');
var reservationBtnProcessing = document.querySelector('#btn-reservation-processing');
...
var makeReservation = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            console.log(_context.t0); // Show spinner
  ...
  return function makeReservation(_x, _x2, _x3, _x4, _x5, _x6) {
...
var directBack = function directBack() {
  location.assign('/');
};
...
exports.checkDate = exports.calendar = exports.daysInMonth = exports.loadCalendarDays = exports.loadCalendarYears = exports.loadCalendarMonths = exports.getReserveDate = exports.months = void 0;
...
var clndr = document.querySelector('.calendar');
var clndrDays = document.querySelector('#calendarDays'); // function getReserveDate(day) {
...
var loadCalendarMonths = function loadCalendarMonths() {
...
exports.loadCalendarMonths = loadCalendarMonths;

var loadCalendarYears = function loadCalendarYears() {
...
exports.loadCalendarYears = loadCalendarYears;

var loadCalendarDays = function loadCalendarDays() {
  ...
  for (var i = 0; i < num; i++) {
    ...
    d.addEventListener('click', function () {
      ...
      var month = document.getElementById('curMonth').innerHTML;
      var year = document.getElementById('curYear').innerHTML;
...
var checkDate = function checkDate() {
  ...
  var datesArray = _toConsumableArray(clndrDays.children);
